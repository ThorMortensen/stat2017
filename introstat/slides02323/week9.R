...
Air20$noise <- rnorm(nrow(Air20))
plot(Air20$logOzone, Air20$noise, xlab="Noise", ylab="log Ozon")
cor(Air20$logOzone, Air20$noise)
...
plot(fitSel$fitted.values, fitSel$residuals, xlab="Prædikteret værdi", ylab="Residualer")
...
################################
## Se problemer der opstår når forklarende variabler er stærkt korrelerede
